...
% solve BVP for eigenfunctions and construct LTI system for undamped system
...
ctrl_path = ('C:\Users\user\Dropbox\projekte\Lehrveranstaltungen\MA\Simulations\matlab\LMI_based_control\MORC\systems\flexible_arm\');
% ctrl_path = ('C:\Users\user\Dropbox\projekte\Lehrveranstaltungen\MA\Simulations\matlab\LMI_based_control\MORC\systems\flexible_arm_q0\');
...
cmp_path = 'C:\Users\user\Dropbox\projekte\Lehrveranstaltungen\MA\Simulations\matlab\LMI_based_control\sys_order_compare\systems\';
dat_str = strcat('sys_data_N',num2str(Na),'.mat');
omega = omeg(1:Na); % aux info
save(strcat(cmp_path,dat_str),'Adyn','Bdyn','gamm','omega')
